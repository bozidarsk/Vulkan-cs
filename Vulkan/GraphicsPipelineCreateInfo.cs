...
public readonly struct GraphicsPipelineCreateInfo : IDisposable
{
	...
	private readonly Box<PipelineShaderStageCreateInfo> stages;
	private readonly Box<PipelineVertexInputStateCreateInfo> vertexInputState;
	private readonly Box<PipelineInputAssemblyStateCreateInfo> inputAssemblyState;
	private readonly Box<PipelineTessellationStateCreateInfo> tessellationState;
	private readonly Box<PipelineViewportStateCreateInfo> viewportState;
	private readonly Box<PipelineRasterizationStateCreateInfo> rasterizationState;
	private readonly Box<PipelineMultisampleStateCreateInfo> multisampleState;
	private readonly Box<PipelineDepthStencilStateCreateInfo> depthStencilState;
	private readonly Box<PipelineColorBlendStateCreateInfo> colorBlendState;
	private readonly Box<PipelineDynamicStateCreateInfo> dynamicState;
